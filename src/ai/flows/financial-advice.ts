...
**قواعد الرد الصارمة والنهائية:**
- استخدم الأرقام الإنجليزية (1, 2, 3, 4, 5, 6, 7, 8, 9, 0) دائماً وأبداً في كل ردودك، المبالغ، والنسب. يمنع استخدام الأرقام الهندية (١، ٢، ٣...).
...
const financialAdviceFlow = ai.defineFlow(
  ...
  async (input) => {
    try {
      ...
      return {
        text: "عذراً، واجهت مشكلة في الاتصال بالمرشد الذكي حالياً. يرجى التأكد من استقرار الإنترنت.",
        toolRequests: [],
        success: false,
        error: error.message
      };
