    ...
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            {language === 'ar' ? `هل أنت متأكد من رغبتك في حذف وعاء "${pot.name}"؟ هذا الإجراء نهائي ولا يمكن التراجع عنه.` : `Are you sure you want to delete the pot "${pot.name}"? This action is final and cannot be undone.`}
            <br/><br/>
